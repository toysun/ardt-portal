...
AFRAME.registerComponent("u2net", {
  schema: {
    ...
    nnModel: { type: "string", default: "https://cdn.glitch.global/7aef11f6-e1ff-4444-833f-2588de98f4e6/u2netp_default.onnx?v=1689779242896" }, // u2netp_320.onnx, u2netp_224.onnx, u2netp_124.onnx
    uiText: { default: "" }, // any text string
    uiLogo: { default: "" }, // 'any logo url'
    uiOverlayColor: { default: "rgba(255, 0, 0, 0.3)" },
  },
  init: function () {
    // Variables
    let canvas;
    ...
    // Check model used
    if (this.data.nnModel == "https://cdn.glitch.global/7aef11f6-e1ff-4444-833f-2588de98f4e6/u2netp_default.onnx?v=1689779242896") {
      w = 320;
      h = 320;
    } else if (this.data.nnModel == "https://github.com/akbartus/A-Frame-Component-U2Net/blob/main/models/u2netp_320.onnx") {
      w = 320;
      h = 320;
    } else if (this.data.nnModel == "https://github.com/akbartus/A-Frame-Component-U2Net/blob/main/models/u2netp_224.onnx") {
      w = 224;
      h = 224;
    } else if (this.data.nnModel == "https://github.com/akbartus/A-Frame-Component-U2Net/blob/main/models/u2netp_124.onnx") {
      w = 124;
      h = 124;
    }
