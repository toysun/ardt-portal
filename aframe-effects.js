  ...
  /******/ [
      ...
      AFRAME.registerSystem("effects", {
        ...
        fuse: function (temp, alpha) {
          ...
          temp.forEach(function (obj) {
            ...
            var prefix =
              (obj.attrName ? obj.attrName : "undefined_" + count++) + "_";
      ...
      AFRAME.registerComponent("bloom", {
        ...
        update: function (oldData) {
          if (oldData.filter !== this.data.filter) {
            if (this.materialHighPassFilter)
              this.materialHighPassFilter.dispose();
            var chain = this.data.filter.length
              ? this.data.filter
              : [this.exports.filter];
        ...
        tock: function (time) {
          ...
          this.exports.filter.uniforms["luminosityThreshold"].value =
            this.data.threshold;
    ...
    /***/ function (module, exports) {
      AFRAME.registerComponent("colors", {
        ...
        update: function (oldData) {
          ...
          [];
          if (
            this.data.lutFlip !== oldData.lutFlip ||
            this.data.lutClamp !== oldData.lutClamp ||
      ...
      AFRAME.registerComponent("godrays", {
        ...
        update: function (oldData) {
          ...
          if (this.data.filter !== oldData.filter) {
            ...
            this.materialFilter = this.system.fuse(
              this.data.filter.length ? this.data.filter : [this.exports.filter]
            );
          }
        ...
        tock: function () {
          ...
          var fn = function (material, camera, eye) {
            var cp3 = new THREE.Vector3(),
              cd3 = new THREE.Vector3();
            ...
            cp3.normalize();
            cd3.normalize();
            self.uniforms.attenuation.value = Math.pow(
              Math.max(0, -cd3.dot(cp3)),
              1.33
            );
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      AFRAME.registerComponent("ssao", {
        ...
        update: function (od) {
          ...
          this.rebuild(
            d.rings !== od.rings || d.samples !== od.samples,
            d.blurRadius !== od.blurRadius
          );
        ...
        rebuild: function (sao, blur) {
          ...
          if (blur) {
            ...
            this.hBlurMaterial = this.system.materialize(
            ...
            this.vBlurMaterial = this.system.materialize(
              DepthLimitedBlurShader(
                d.blurRadius,
                d.blurRadius / 2,
        ...
        tock: function (time) {
          ...
          ].value.getInverse(this.el.sceneEl.camera.projectionMatrix);
          ...
          this.SAOMaterial.uniforms.tDepth.value =
            this.el.sceneEl.renderTarget.depthTexture;
    ...
    /***/ function (module, exports) {
      ...
      module.exports = function (radius, stdDev, uvIncrement) {
        radius = radius || 4;
        var config = THREE.BlurShaderUtils.configure(
          radius,
          stdDev,
          uvIncrement
        );
      ...
      AFRAME.registerShader("standard-fx", {
        ...
        updateEnvMap: function (data) {
          ...
          texturePromises[envMap] = new Promise(function (resolve) {
            utils.srcLoader.validateCubemapSrc(
              envMap,
              function loadEnvMap(urls) {
