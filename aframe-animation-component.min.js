      ...
      function (t, e, n) {
        function r(t, e) {
          ...
          return (
            ...
            (r = i[0]),
            (a = i[1]),
            (n = t.components[r] || AFRAME.components[r]),
            n
              ? a && !n.schema[a]
                ? null
                : a
        ...
        function u(t, e, n, r) {
          ...
          return (
            ...
            r === v
              ? void ("r" in s[o]
                  ? ((s[o].r = n.r), (s[o].g = n.g), (s[o].b = n.b))
                  : ((s[o].x = n.r), (s[o].y = n.g), (s[o].z = n.b)))
              : void (s[o] = n)
          );
        }
        function f(t) {
        ...
        function l(t) {
          return (
            t.isRawProperty ||
            t.property.startsWith(E) ||
            t.property.startsWith(w)
          );
        }
        var c = n(1);
        if (((AFRAME.anime = c), "undefined" == typeof AFRAME))
          throw new Error(
        ...
        AFRAME.registerComponent("animation", {
              ...
              (this.config = {
                complete: function () {
                  (t.animationIsPlaying = !1),
                    t.el.emit("animationcomplete", t.eventDetail),
                    t.id &&
                      t.el.emit(
          ...
          update: function (t) {
            ...
            return (
              ...
              t.enabled && !this.data.enabled
                ? void (this.animationIsPlaying = !1)
                : void (
                    n.property &&
                    ((e.autoplay = !1),
                    (e.direction = n.dir),
          ...
          onStartEvent: function () {
            if (this.data.enabled)
              return (
                ...
                (this.animation = c(this.config)),
                this.data.delay
                  ? void setTimeout(this.beginAnimation, this.data.delay)
                  : void this.beginAnimation()
              );
          },
          updateConfigForRawColor: function () {
            ...
            if (
              ...
              (t = i.from || s(a, i.property)),
                (n = i.to),
                this.setColorConfig(t, n),
                (t = this.fromColor),
                (n = this.toColor),
              ...
              r.update = (function () {
                ...
                return (
                  ...
                  function (t) {
                    var n;
                    (n = t.animatables[0].target),
                      (n.r === e.r && n.g === e.g && n.b === e.b) ||
                        u(a, i.property, n, i.type);
                  }
                );
              })();
            }
          ...
          updateConfigForDefault: function () {
            ...
            this.waitComponentInitRawProperty(this.updateConfigForDefault) ||
              ((t = a.from || (l(a) ? s(o, a.property) : m(o, a.property))),
              (r = a.to),
              (n = !isNaN(t || r)),
              n
                ? ((t = parseFloat(t)), (r = parseFloat(r)))
                : ((t = t ? t.toString() : t), (r = r ? r.toString() : r)),
              (e = "true" === r || "false" === r),
              e &&
                ((t = "true" === a.from ? 1 : 0),
                (r = "true" === a.to ? 1 : 0)),
              (this.targets.aframeProperty = t),
              (i.targets = this.targets),
              (i.aframeProperty = r),
              (i.update = (function () {
                var n = t;
                return function (t) {
                  var r;
                  (r = t.animatables[0].target.aframeProperty),
                    r !== n &&
                      ((n = r),
                      e && (r = r >= 1),
                      l(a) ? u(o, a.property, r, a.type) : g(o, a.property, r));
                };
              })()));
          },
          updateConfigForVector: function () {
            var t,
              ...
              o = this.el;
            (e = a.from
              ? AFRAME.utils.coordinates.parse(a.from)
              : m(o, a.property)),
              (n = AFRAME.utils.coordinates.parse(a.to)),
              a.property === A && (i(e), i(n)),
              (this.targetsArray.length = 0),
              this.targetsArray.push(e),
              (r.targets = this.targetsArray);
            for (t in n) r[t] = n[t];
            return a.property === b || a.property === A || a.property === x
                  ...
                  return (
                    ...
                    function (e) {
                      ...
                      (n.x === t.x && n.y === t.y && n.z === t.z) ||
                        ...
                        (t.y = n.y),
                        (t.z = n.z),
                        o.object3D[a.property].set(n.x, n.y, n.z));
                    }
                  );
                })())
              : void (r.update = (function () {
          ...
          updateConfig: function () {
            var t;
            (t = r(this.el, this.data.property)),
              l(this.data) && this.data.type === v
                ? this.updateConfigForRawColor()
          ...
          waitComponentInitRawProperty: function (t) {
            ...
            return (
              !n.from &&
              !!n.property.startsWith(E) &&
              ((e = f(n.property)[1]),
              !r.components[e] &&
                (r.addEventListener("componentinitialized", function n(a) {
                  a.detail.name === e &&
                    (t(),
                    (i.animation = c(i.config)),
                    r.removeEventListener("componentinitialized", n));
                }),
                !0))
            );
          },
          ...
          addEventListeners: function () {
            var t = this.data,
              e = this.el;
            a(e, t.startEvents, this.onStartEvent),
              a(e, t.pauseEvents, this.pauseAnimation),
              a(e, t.resumeEvents, this.resumeAnimation);
          },
          removeEventListeners: function () {
            var t = this.data,
              e = this.el;
            o(e, t.startEvents, this.onStartEvent),
              o(e, t.pauseEvents, this.pauseAnimation),
              o(e, t.resumeEvents, this.resumeAnimation);
          },
        ...
        (function (n) {
          ...
          (o.defineProperty =
            ...
            (o.initSymbolIterator = function () {
              ...
              t || (t = o.global.Symbol.iterator = o.global.Symbol("iterator")),
          ...
          !(function (n, o) {
            ...
            function m(t, e) {
              return N.dom(t) && i(D, e)
                ? "transform"
                : N.dom(t) && (t.getAttribute(e) || (N.svg(t) && t[e]))
                ? "attribute"
                : N.dom(t) && "transform" !== e && h(t, e)
                ? "css"
                : null != t[e]
                ? "object"
                : void 0;
            ...
            function w(t, e) {
              ...
              if (((n = N.pth(t) ? t.totalLength : t), N.col(n)))
                ...
                (i = (i = c(n)) ? n.substr(0, n.length - i.length) : n),
            ...
            function I(t, e) {
              ...
              if (N.arr(t)) {
                var i = t.length;
                2 !== i || N.obj(t[0])
                  ? N.fnc(e.duration) || (n.duration = e.duration / i)
                  : (t = { value: t });
              }
              return r(t)
                .map(function (t, n) {
            ...
            function F(t) {
              return N.arr(t) ? _.apply(this, t) : $[t];
            }
            function S(t, e) {
              var n;
            ...
            function O(t) {
              ...
              for (e in t)
                s.hasOwnProperty(e) ||
                  "targets" === e ||
                  a.push({ name: e, offset: s.offset, tweens: I(t[e], r) });
              return (
                (t = R(i, a)),
                u(n, {
                  children: [],
            ...
            function T(t) {
              ...
              function i(t) {
                for (
                  var n = 0, r = {}, i = d.animations, a = i.length;
                  n < a;
                  ...
                  H[o.type](s.target, o.property, m, r, s.id),
                    (o.currentValue = m),
                    n++;
                }
                if ((n = Object.keys(r).length))
                  for (i = 0; i < n; i++)
                    z ||
                      (z = h(document.body, "transform")
                        ? "transform"
                        : "-webkit-transform"),
                      (d.animatables[i].target.style[z] = r[i].join(" "));
              ...
              function s(t) {
                ...
                (y >= h || !e) &&
                  (d.began || ((d.began = !0), a("begin")), a("run")),
                  y > s && y < e
                    ? i(y)
                    : (y <= s && 0 !== m && (i(0), g && o()),
                      ((y >= e && m !== e) || !e) && (i(e), g || o())),
            ...
            var z,
              ...
              _ = (function () {
                ...
                return function (e, n, r, i) {
                  if (0 <= e && 1 >= e && 0 <= r && 1 >= r) {
                    ...
                    if (e !== n || r !== i)
                      for (var o = 0; 11 > o; ++o) a[o] = t(0.1 * o, e, r);
                    return function (o) {
                      if (e === n && r === i) return o;
                      if (0 === o) return 0;
                      if (1 === o) return 1;
                      for (var s = 0, u = 1; 10 !== u && a[u] <= o; ++u)
                        s += 0.1;
                      --u;
                      var u = s + ((o - a[u]) / (a[u + 1] - a[u])) * 0.1,
                        f =
                          3 * (1 - 3 * r + 3 * e) * u * u +
                          2 * (3 * r - 6 * e) * u +
                          3 * e;
              ...
              $ = (function () {
                ...
                var e,
                  ...
                  i = { linear: _(0.25, 0.25, 0.75, 0.75) },
                  a = {};
                for (e in r)
                  (a.type = e),
                    r[a.type].forEach(
            ...
            return (
              ...
              (T.remove = function (t) {
                ...
                for (var e = V.length; e--; )
                  for (var n = V[e], r = n.animations, a = r.length; a--; )
                    i(t, r[a].animatable.target) &&
                      (r.splice(a, 1), r.length || n.pause());
              }),
              (T.getValue = y),
              (T.path = function (e, n) {
