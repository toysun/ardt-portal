...
const bobComponent = {
  ...
  init() {
    ...
    data.downPosition = data.initialPosition
      .clone()
      .setY(data.initialPosition.y - data.distance);
    data.upPosition = data.initialPosition
      .clone()
      .setY(data.initialPosition.y + data.distance);
    ...
    data.timeout = null;
    const animatePosition = position =>
...
export { portalComponent, bobComponent };
