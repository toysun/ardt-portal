    ...
    AFRAME.registerComponent("shooter", {
      ...
      onChangeBullet: function (e) {
        ...
        if ("next" === e.detail) {
          ...
          return (
            (t = i.cycle
              ? (t + 1) % i.bulletTypes.length
              : Math.min(i.bulletTypes.length - 1, t + 1)),
            (i.activeBulletType = i.bulletTypes[t]),
            void n.setAttribute("shooter", "activeBulletType", i.bulletTypes[t])
          );
        }
        if ("prev" === e.detail) {
          if (-1 === (t = i.bulletTypes.indexOf(i.activeBulletType))) return;
          return (
            (t = i.cycle ? (t - 1) % i.bulletTypes.length : Math.max(0, t - 1)),
            (i.activeBulletType = i.bulletTypes[t]),
            void n.setAttribute("shooter", "activeBulletType", i.bulletTypes[t])
          );
        }
      ...
      AFRAME.registerSystem("bullet", {
        ...
        registerTarget: function (e, t) {
          ...
          this.targets.push(e.el),
            t &&
              ((i = e.el.object3D).boundingBox = new THREE.Box3().setFromObject(
                i
              ));
        },
        shoot: function (e, t) {
      ...
      AFRAME.registerComponent("target", {
        ...
        onBulletHit: function (e) {
          this.data.active &&
            ((this.lastBulletHit = e),
            (this.healthPoints -= e.damagePoints),
            this.healthPoints <= 0 && this.el.emit("die"));
        },
      });
  },
]);
